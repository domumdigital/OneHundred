...
contract OneHundred is VRFConsumerBaseV2Plus, AutomationCompatibleInterface, ReentrancyGuard {
    ...
    // Add this temporary function to your contract
function emergencyResetSelectedNumbers(uint256 roundNumber) external onlyOwner {
    require(roundNumber > 0, "Invalid round number");
    
    // Loop through all possible numbers and reset them
